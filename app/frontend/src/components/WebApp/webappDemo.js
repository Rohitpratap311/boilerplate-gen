...
function QADemo() {
  ...
  const handleSubmit = (event) => {
    ...
    if (formValues.dev === "AR_VR"|| formValues.frontend === "HTML" || formValues.backend === "NodeJS" || formValues.db === "MongoDB" || formValues.frontend === "Flutter"){
  ...
  return (
    <div style={{ textAlign: "center", padding: "40px" }}>
      ...
      <div className={classes.container}>
            ...
            { isSubmit && (formValues.dev !== "AR_VR"|| formValues.frontend !== "HTML" || formValues.backend !== "NodeJS" || formValues.frontend !== "Flutter" || formValues.db !== "MongoDB") ? (
