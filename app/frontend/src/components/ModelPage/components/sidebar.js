...
import mobileappDocs from '../../MobileApp/mobileappDocs.js'
import webappDocs from '../../WebApp/webappDocs.js'
...
export default function PersistentDrawerLeft() {
  ...
  const [sidebar, setSidebar] = React.useState({'webappDocs' : false, 'mobileappDocs' : false});

  const handleSidebarState = (choose) => {
      if (choose==='webappDocs'){
        setSidebar({'webappDocs' : true, 'mobileappDocs' : false})
      }
      else if (choose==='mobileappDocs'){
        setSidebar({'webappDocs' : false, 'mobileappDocs' : true})
      }
      else{
        setSidebar({'webappDocs' : false, 'mobileappDocs' : false})
      }
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <List>
            ...
            <ListItem button key='AutomaticQuestionPaper' onClick= {() => handleSidebarState('webappDocs')}>
              <ListItemIcon>
            ...
            <ListItem button key='cdqa' onClick= {() => handleSidebarState('mobileappDocs')}>
              <ListItemIcon>
      ...
      >
        ...
        {
            sidebar.webappDocs ? <webappDocs /> : sidebar.Ask ? <mobileappDocs /> : <Default />
        }
